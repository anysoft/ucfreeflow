...
public class IniFileUtils {
    public static final String ALI_FISH_TAG = "AliFish";
    public static final String ALI_ANT_TAG = "AliAnt";
    public static final String FILE_PATH = Environment.getExternalStorageDirectory().getAbsolutePath() + "/UCDownloads/freeflow.ini";
    ...
    public IniFileUtils(){
        File freeflow = new File(FILE_PATH);
        ...
        this.file = freeflow;
        initFromFile(freeflow);

    }

    public IniFileUtils(File file) {
        this.file = file;
        initFromFile(file);
    }

    public IniFileUtils(InputStream inputStream) {
